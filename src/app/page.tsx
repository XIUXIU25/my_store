...
import Phone from "@/componenets/Phone"
          ...
          <div className="col-span-2 px-6 lg:px-0 lg:pt-4">
            <div className="relative mx-auto text-center lg:text-left flex flex-col items-center lg:items-start">
              ...
              <p className="mt-8 text-lg lg:pr-10 max-w-prose text-center lg:text-left text-balance md:text-wrap">
                ...
                <span className="font-semibold">one-of-one </span>photo case. 
              ...
              <div className="mt-12 flex fle-col sm:flex-row items-center sm:items-start gap-5">
        ...
        <MaxWidthWrapper className="flex flex-col items-center gap-16 sm:gap-32">
          <div className='flex flex-col lg:flex-row items-center gap-4 sm:gap-6'>
            <h2 className="order-1 mt-2 tracking-tight text-center text-balance !leading-tight font-bold text-5xl md:text-6xl text-gray-900">
              What our <span className="relative px-2">customers<Icons.underline className="hidden sm:block pointer-events-none absolute inset-x-0 -bottom-6 text-green-500
              "/></span> say
              </h2>
              ...
              <div className="text-lg leading-8">
                <p>
                  "The case feels durable and I even got a
                   compliments on the design. Had the case for two and a half month now and <span className="p-0.5 bg-slate-800 text-white">the image is super clear</span>,on the case I had before, the image started fading into yellow-ish color after couple weeks.love it"
                </p>
              </div>
              <div className="flex gap-4 mt-2">
                <img className="rounded-full h-12 w-12 object-cover" src='/users/user-1.jpg' alt='user'/>
                <div className="flex flex-col">
                  <p className="font-semibold">JingJie</p>
